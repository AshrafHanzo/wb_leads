import { User, Account, Lead, LeadStage, LeadStageStatus, LeadWithDetails, IndustryMaster, LeadSourceMaster } from '@/types';

export const mockIndustryMaster: IndustryMaster[] = [
  { industry_id: 1, industry_name: 'Technology' },
  { industry_id: 2, industry_name: 'Finance' },
  { industry_id: 3, industry_name: 'Healthcare' },
  { industry_id: 4, industry_name: 'Retail' },
  { industry_id: 5, industry_name: 'Education' },
  { industry_id: 6, industry_name: 'Manufacturing' },
  { industry_id: 7, industry_name: 'Real Estate' },
  { industry_id: 8, industry_name: 'Hospitality' },
  { industry_id: 9, industry_name: 'Transportation' },
  { industry_id: 10, industry_name: 'Other' },
];

export const mockLeadSourceMaster: LeadSourceMaster[] = [
  { source_id: 1, source_name: 'Website' },
  { source_id: 2, source_name: 'LinkedIn' },
  { source_id: 3, source_name: 'Intern' },
  { source_id: 4, source_name: 'Employee' },
  { source_id: 5, source_name: 'Referral' },
  { source_id: 6, source_name: 'Cold Call' },
  { source_id: 7, source_name: 'Email Campaign' },
  { source_id: 8, source_name: 'Trade Show' },
  { source_id: 9, source_name: 'Partner' },
];
...
export const mockAccounts: Account[] = [
  { account_id: 1, account_name: 'TechCorp Solutions', industry: 'Technology', head_office: 'San Francisco', company_website: 'https://techcorp.com', primary_contact_name: 'John Smith', contact_person_role: 'CTO', contact_phone: '+1555123456', contact_email: 'john@techcorp.com', company_phone: '+1555123000', total_meetings_conducted: 5, total_pocs: 2, total_revenue: 75000, account_status: 'Active', account_owner: 2, lead_source: 'LinkedIn', remarks: 'Key enterprise client', created_date: '2024-01-15T00:00:00Z', last_updated: '2024-12-10T00:00:00Z' },
  { account_id: 2, account_name: 'Global Finance Inc', industry: 'Finance', head_office: 'New York', company_website: 'https://globalfinance.com', primary_contact_name: 'Lisa Wang', contact_person_role: 'CFO', contact_phone: '+1555234567', contact_email: 'lisa@globalfinance.com', company_phone: '+1555234000', total_meetings_conducted: 8, total_pocs: 3, total_revenue: 120000, account_status: 'Active', account_owner: 2, lead_source: 'Referral', remarks: 'Long-term partnership', created_date: '2024-02-01T00:00:00Z', last_updated: '2024-12-12T00:00:00Z' },
  { account_id: 3, account_name: 'HealthFirst Medical', industry: 'Healthcare', head_office: 'Boston', company_website: 'https://healthfirst.com', primary_contact_name: 'Dr. Robert Chen', contact_person_role: 'Director', contact_phone: '+1555345678', contact_email: 'robert@healthfirst.com', company_phone: '+1555345000', total_meetings_conducted: 3, total_pocs: 1, total_revenue: 45000, account_status: 'Prospect', account_owner: 4, lead_source: 'Website', remarks: 'Interested in enterprise plan', created_date: '2024-06-15T00:00:00Z', last_updated: '2024-12-08T00:00:00Z' },
  { account_id: 4, account_name: 'RetailMax Corp', industry: 'Retail', head_office: 'Chicago', company_website: 'https://retailmax.com', primary_contact_name: 'Amanda Foster', contact_person_role: 'VP Operations', contact_phone: '+1555456789', contact_email: 'amanda@retailmax.com', company_phone: '+1555456000', total_meetings_conducted: 2, total_pocs: 0, total_revenue: 0, account_status: 'Dormant', account_owner: 2, lead_source: 'Employee', remarks: 'Paused discussions', created_date: '2024-03-01T00:00:00Z', last_updated: '2024-09-15T00:00:00Z' },
  { account_id: 5, account_name: 'EduLearn Systems', industry: 'Education', head_office: 'Austin', company_website: 'https://edulearn.com', primary_contact_name: 'Mark Thompson', contact_person_role: 'CEO', contact_phone: '+1555567890', contact_email: 'mark@edulearn.com', company_phone: '+1555567000', total_meetings_conducted: 4, total_pocs: 2, total_revenue: 55000, account_status: 'Active', account_owner: 4, lead_source: 'LinkedIn', remarks: 'Expanding to new markets', created_date: '2024-07-01T00:00:00Z', last_updated: '2024-12-14T00:00:00Z' },
];
...
export const mockLeads: Lead[] = [
  { lead_id: 1, account_id: 1, lead_date: '2024-12-01T10:00:00Z', lead_source: 'LinkedIn', lead_generated_by: 5, assigned_telecaller: 3, bd_assigned_to: 2, stage_id: 4, status_id: 6, last_contacted_at: '2024-12-14T00:00:00Z', next_followup_at: '2024-12-18T00:00:00Z', expected_value: 25000, products_interested: 'Enterprise Suite, Analytics', product_mapped: 'Enterprise Suite', remarks: 'Very interested in analytics features', created_date: '2024-12-01T10:00:00Z', updated_date: '2024-12-14T00:00:00Z' },
  { lead_id: 2, account_id: 2, lead_date: '2024-11-15T09:00:00Z', lead_source: 'Referral', lead_generated_by: 4, assigned_telecaller: 6, bd_assigned_to: 2, stage_id: 5, status_id: 8, last_contacted_at: '2024-12-12T00:00:00Z', next_followup_at: '2024-12-16T00:00:00Z', expected_value: 50000, products_interested: 'Full Platform', product_mapped: 'Full Platform', remarks: 'Negotiating annual contract', created_date: '2024-11-15T09:00:00Z', updated_date: '2024-12-12T00:00:00Z' },
  { lead_id: 3, account_id: 3, lead_date: '2024-12-10T14:00:00Z', lead_source: 'Website', lead_generated_by: 5, assigned_telecaller: 3, bd_assigned_to: null, stage_id: 2, status_id: 3, last_contacted_at: '2024-12-15T00:00:00Z', next_followup_at: '2024-12-17T00:00:00Z', expected_value: 15000, products_interested: 'Basic Plan', product_mapped: '', remarks: 'Initial call completed', created_date: '2024-12-10T14:00:00Z', updated_date: '2024-12-15T00:00:00Z' },
  { lead_id: 4, account_id: 5, lead_date: '2024-12-05T11:00:00Z', lead_source: 'LinkedIn', lead_generated_by: 2, assigned_telecaller: 6, bd_assigned_to: 2, stage_id: 3, status_id: 5, last_contacted_at: '2024-12-13T00:00:00Z', next_followup_at: '2024-12-19T00:00:00Z', expected_value: 30000, products_interested: 'Education Module', product_mapped: 'Education Module', remarks: 'Demo scheduled for next week', created_date: '2024-12-05T11:00:00Z', updated_date: '2024-12-13T00:00:00Z' },
  { lead_id: 5, account_id: 1, lead_date: '2024-12-12T08:00:00Z', lead_source: 'Employee', lead_generated_by: 4, assigned_telecaller: 3, bd_assigned_to: null, stage_id: 1, status_id: 1, last_contacted_at: null, next_followup_at: '2024-12-16T00:00:00Z', expected_value: 10000, products_interested: 'Add-on Services', product_mapped: '', remarks: 'Cross-sell opportunity', created_date: '2024-12-12T08:00:00Z', updated_date: '2024-12-12T00:00:00Z' },
  { lead_id: 6, account_id: 4, lead_date: '2024-10-01T10:00:00Z', lead_source: 'Website', lead_generated_by: 5, assigned_telecaller: 6, bd_assigned_to: 2, stage_id: 7, status_id: 12, last_contacted_at: '2024-10-15T00:00:00Z', next_followup_at: null, expected_value: 0, products_interested: 'Retail Solution', product_mapped: '', remarks: 'Budget constraints', created_date: '2024-10-01T10:00:00Z', updated_date: '2024-10-15T00:00:00Z' },
];
